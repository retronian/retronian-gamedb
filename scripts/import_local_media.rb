...
#              cartridge | disc | logo
#   platform = fc | sfc | gb | gbc | gba | md | pce | saturn | n64 | nds | ps1 | ps2
...
VALID_PLATFORMS = %w[fc sfc gb gbc gba md pce ws wsc arcade cps3 neogeo saturn n64 nds ps1 ps2 psp pico8 pcfx].freeze
